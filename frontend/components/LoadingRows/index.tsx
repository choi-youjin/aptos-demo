...
import isNthChild from '@/components/LoadingRows/isNthChild';
import { BG_CLASS_DICT, type LoaderStyle, type LoadingRowsColor } from '@/components/LoadingRows/styles';
